...
import { cities, defaultComparison, getComparisonPath } from "@/lib/cost-data"
...
export function CompareLauncher() {
  ...
  return (
    <div className="home-launcher" aria-label="Start a city comparison">
      ...
      <Link href={getComparisonPath(from, to)}>Compare these cities <span>→</span></Link>
      <p>{cities.length} cities currently available · Search by city or country · Prototype USD estimates</p>
    </div>
  )
}
